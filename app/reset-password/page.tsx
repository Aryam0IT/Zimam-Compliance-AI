  ...
  const t = useMemo(() => {
    const dict = {
      ar: {
        ...
        brandTitle: 'إعادة التعيين',
        brandDesc: 'خطوة واحدة وتدخلين.',
      },
      en: {
        ...
        back: 'Back to Login',
        brandTitle: 'Reset',
        brandDesc: 'One step and you’re in.',
      },
    } as const;
    return dict[lang];
  }, [lang]);
  ...
  return (
    ...
    >
      <form onSubmit={onSubmit} className="authForm" dir={dir}>
        ...
        <div className="inputRow">
          <input type="password" placeholder={t.newPass} required />
        </div>
        ...
        <style jsx>{`
          ...
          .inputRow { background:#f4f7f6; border:1px solid transparent; border-radius:16px; padding:12px 14px; margin:10px 0; }
          ...
          .primary { width:100%; background:#1f513e; color:#fff; border:none; border-radius:999px; padding:12px 18px; font-weight:800; cursor:pointer; margin-top:6px; }
